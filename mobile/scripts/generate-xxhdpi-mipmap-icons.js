...
// ============================================================================
// Android xxhdpi Mipmap Icon Generator
// ============================================================================

/**
 * Script to generate all Android xxhdpi mipmap app icons
 * 
 * Run: node scripts/generate-xxhdpi-mipmap-icons.js
 * 
 * Prerequisites:
...
// xxhdpi mipmap icon configurations (144x144)
const XXHDPI_MIPMAP_CONFIG = {
  'mipmap-xxhdpi': {
...
async function generateXxhdpiMipmapIcons() {
  console.log('🎨 Generating Android xxhdpi mipmap app icons...');
  console.log('================================================\n');
  ...
  // Generate xxhdpi mipmap icons
  await generateStandardXxhdpiMipmapIcons(sourceBuffer);
  await generateAdaptiveXxhdpiIcons(sourceBuffer);
  await generateXxhdpiXMLFiles();

  console.log('\n🎉 All Android xxhdpi mipmap icons generated successfully!');
  console.log('================================================');
}

// ============================================================================
// Generate Standard xxhdpi Mipmap Icons
// ============================================================================

async function generateStandardXxhdpiMipmapIcons(sourceBuffer) {
  console.log('📱 Generating standard xxhdpi mipmap icons (144x144)...');

  for (const [density, config] of Object.entries(XXHDPI_MIPMAP_CONFIG)) {
...
# ============================================================================
# ImageMagick Commands for xxhdpi Mipmap Icons
# ============================================================================

# 1. Create mipmap-xxhdpi regular icon (144x144)
convert source.png -resize 144x144 -background none -gravity center \\
  -extent 144x144 -antialias android/app/src/main/res/mipmap-xxhdpi/ic_launcher.png
...
convert source.png -resize 144x144 -background none -gravity center \\
  ...
  -antialias android/app/src/main/res/mipmap-xxhdpi/ic_launcher_round.png

# 3. Adaptive xxhdpi icons (324x324)
# Foreground
convert source.png -resize 195x195 -background none -gravity center \\
  -extent 324x324 -antialias android/app/src/main/res/mipmap-xxhdpi/ic_launcher_foreground.png
...
// Generate all xxhdpi mipmap icons
generateXxhdpiMipmapIcons().catch(console.error);