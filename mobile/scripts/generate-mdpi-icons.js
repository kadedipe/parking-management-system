...
// ============================================================================
// Android mdpi Icon Generator
// ============================================================================

/**
 * Script to generate all Android mdpi app icons
 * 
 * Run: node scripts/generate-mdpi-icons.js
 * 
 * Prerequisites:
...
// mdpi icon configurations (48x48)
const MDPI_CONFIG = {
  // Drawable icons
  'drawable-mdpi': {
...
async function generateMdpiIcons() {
  console.log('🎨 Generating Android mdpi app icons...');
  console.log('================================================\n');
  ...
  // Generate mdpi icons
  await generateStandardMdpiIcons(sourceBuffer);
  await generateAdaptiveMdpiIcons(sourceBuffer);
  await generateMdpiXMLFiles();

  console.log('\n🎉 All Android mdpi icons generated successfully!');
  console.log('================================================');
}

// ============================================================================
// Generate Standard mdpi Icons
// ============================================================================

async function generateStandardMdpiIcons(sourceBuffer) {
  console.log('📱 Generating standard mdpi icons (48x48)...');

  for (const [density, config] of Object.entries(MDPI_CONFIG)) {
...
# ============================================================================
# ImageMagick Commands for mdpi Icons
# ============================================================================

# Create mdpi regular icon (48x48)
convert source.png -resize 48x48 -background none -gravity center \\
  -extent 48x48 android/app/src/main/res/drawable-mdpi/ic_launcher.png

# Create mdpi round icon (48x48)
convert source.png -resize 48x48 -background none -gravity center \\
...
# Create mipmap-mdpi icons
convert source.png -resize 48x48 -background none -gravity center \\
  -extent 48x48 android/app/src/main/res/mipmap-mdpi/ic_launcher.png
...
// Generate all mdpi icons
generateMdpiIcons().catch(console.error);