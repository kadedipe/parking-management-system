...
// ============================================================================
// Android xhdpi Icon Generator
// ============================================================================

/**
 * Script to generate all Android xhdpi app icons
 * 
 * Run: node scripts/generate-xhdpi-icons.js
 * 
 * Prerequisites:
...
// xhdpi icon configurations (96x96)
const XHDPI_CONFIG = {
  // Drawable icons
  'drawable-xhdpi': {
...
async function generateXhdpiIcons() {
  console.log('🎨 Generating Android xhdpi app icons...');
  console.log('================================================\n');
  ...
  // Generate xhdpi icons
  await generateStandardXhdpiIcons(sourceBuffer);
  await generateAdaptiveXhdpiIcons(sourceBuffer);
  await generateXhdpiXMLFiles();

  console.log('\n🎉 All Android xhdpi icons generated successfully!');
  console.log('================================================');
}

// ============================================================================
// Generate Standard xhdpi Icons
// ============================================================================

async function generateStandardXhdpiIcons(sourceBuffer) {
  console.log('📱 Generating standard xhdpi icons (96x96)...');

  for (const [density, config] of Object.entries(XHDPI_CONFIG)) {
...
# ============================================================================
# ImageMagick Commands for xhdpi Icons
# ============================================================================

# 1. Create drawable-xhdpi regular icon (96x96)
convert source.png -resize 96x96 -background none -gravity center \\
  -extent 96x96 android/app/src/main/res/drawable-xhdpi/ic_launcher.png

# 2. Create drawable-xhdpi round icon (96x96)
convert source.png -resize 96x96 -background none -gravity center \\
...
# 3. Create mipmap-xhdpi icons
convert source.png -resize 96x96 -background none -gravity center \\
  -extent 96x96 android/app/src/main/res/mipmap-xhdpi/ic_launcher.png
...
# 4. Adaptive xhdpi icons (216x216)
# Foreground
convert source.png -resize 130x130 -background none -gravity center \\
  -extent 216x216 android/app/src/main/res/mipmap-xhdpi/ic_launcher_foreground.png
...
// Generate all xhdpi icons
generateXhdpiIcons().catch(console.error);