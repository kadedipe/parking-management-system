 ...
 * 
 * Run: node scripts/generate-ios-all-icons.js
 * 
 * Prerequisites:
...
const ICON_CONFIGS = [
  ...
  // iPad
  { size: 20, scale: '1x', filename: 'icon-20.png' },
  { size: 20, scale: '2x', filename: 'icon-20@2x.png' },
  { size: 29, scale: '1x', filename: 'icon-29.png' },
  { size: 29, scale: '2x', filename: 'icon-29@2x.png' },
  { size: 40, scale: '1x', filename: 'icon-40.png' },
  { size: 40, scale: '2x', filename: 'icon-40@2x.png' },
  { size: 76, scale: '1x', filename: 'icon-76.png' },
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" width="1024" height="1024">
  ...
  <rect x="12" y="12" width="1000" height="1000" rx="218" fill="none" stroke="#ffffff" stroke-width="4" opacity="0.15" />
...
async function generateIcons() {
  ...
  if (!fs.existsSync(SOURCE_IMAGE)) {
    ...
    console.log('   - Create a 1024x1024 logo from the SVG above');
...
async function generateContentsJSON() {
  const contents = {
    images: ICON_CONFIGS.map(config => ({
      ...
      idiom: config.size === 1024 ? 'ios-marketing' : 'universal',
